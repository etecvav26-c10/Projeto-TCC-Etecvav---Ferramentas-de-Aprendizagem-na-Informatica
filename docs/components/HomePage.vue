  ...
  <div class="custom-homepage">
    <nav>
      ...
      <ul class="nav-links">
        ...
        <li><a href="/Ferramentas_B">Guia para Iniciantes</a></li>
        <li><a href="/Introducao">Documentação</a></li>
      </ul>
    </nav>
...
onMounted(() => {
  // Isso carrega dinamicamente seu script JS assim que a estrutura do site terminar de renderizar
  const script = document.createElement('script')
  script.src = '/Hub_Script.js'
  script.async = true
...
<style>
/* Fontes importadas globalmente */
@import url('https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700;800;900&family=Fredoka+One&display=swap');
/* Carrega os estilos customizados salvos na pasta public */
@import url('/Hub_Principal.css');

/* Garante que o layout customizado ocupe a tela sem as margens padrão do markdown */
.custom-homepage {
  width: 100%;
  margin: 0;
  padding: 0;
